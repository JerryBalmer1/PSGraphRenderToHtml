...
| PSTerraformGraph | **consumer, next.** The first real producer, and the first genuine test of whether the contract fits a domain nobody had in mind while writing it |
